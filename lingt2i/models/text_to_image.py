...
from lingt2i.dimensions import gpt_logit_dimension_msg, DIM_NAME_DICT
import tempfile
import os
from PIL import Image
...
class SD15DDPOModel(BaseModel):
    ...
    def __init__(self):
        ...
        lora_path = self.get_model_path(
            "models/sd15_ddpo/pytorch_lora_weights.safetensors",
            "SD15_DDPO_LORA_PATH",
        )
...
class FLUXFTModel(BaseModel):
    ...
    def __init__(self):
        ...
        lora_path = self.get_model_path(
            "models/flux_ft/pytorch_lora_weights.safetensors",
            "FLUX_FT_LORA_PATH",
        )
        from diffusers import FluxPipeline
        self.pipe = FluxPipeline.from_pretrained(
...
class JanusFlowModel(BaseModel):
    def __init__(self):
        ...
        from .janusflow.models import VLChatProcessor
...
class X2IModel(BaseModel):
    ...
    def get_proj(self, proj_path):
        from lingt2i.tools.x2i.projection import create_proj3_qwen3b, create_proj3_qwen7b
