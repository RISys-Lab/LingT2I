...
from .projection import create_proj3_qwen3b, create_proj3_qwen7b
...
parser.add_argument('--input_json', type=str, default="data/legacy/text-to-image-multilingual.json")
parser.add_argument('--output_dir', type=str, default="outputs/content_generation/X2I")
...
qwen_proj_path = 'models/X2I/X2I-Qwen2.5VL-7B.bin'
