...
from lingt2i.utils import encode_image
import torch
from lingt2i.dimensions import gpt_logit_system_msg, gpt_logit_dimension_msg
...
if __name__ == "__main__":
    ...
    parser.add_argument("--judge_model", type=str, default="Qwen/Qwen2.5-VL-72B-Instruct-AWQ",
                       help="Model served by the OpenAI-compatible endpoint")
    parser.add_argument("--image_dir", type=str, default=None)
    parser.add_argument("--prompt_file", type=str, default="data/legacy/text-to-image-multilingual.json")
    ...
    # 自动拼接路径
    image_dir = args.image_dir or os.path.join(project_root, "outputs", "content_generation", model_name)
    prompt_file = args.prompt_file
    output_csv = args.output_csv or os.path.join(project_root, "results", "trig_score", f"{model_name}.csv")
