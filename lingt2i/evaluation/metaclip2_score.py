...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", default=str(PROJECT_ROOT / "outputs" / CONTENT_GENERATION_SPLIT / "zimage"))
    ...
    parser.add_argument("--out_csv", default=str(PROJECT_ROOT / "results" / "metaclip2_zimage.csv"))
