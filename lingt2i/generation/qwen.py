...
from lingt2i.data import DEFAULT_DATASET, TEXT_RENDERING_SPLIT, iter_range, load_text_rendering_data, replace_render_token
...
# 配置
OUTPUT_DIR = os.path.join(ROOT_DIR, "outputs", "text_rendering", "qwen_image")
