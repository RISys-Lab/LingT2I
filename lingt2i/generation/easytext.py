...
from lingt2i.data import DEFAULT_DATASET, TEXT_RENDERING_SPLIT, load_text_rendering_data, replace_render_token
...
def parse_args():
    parser = argparse.ArgumentParser(description='EasyText image generation for LingT2I')
