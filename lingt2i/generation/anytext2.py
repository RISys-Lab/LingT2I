...
from lingt2i.data import DEFAULT_DATASET, TEXT_RENDERING_SPLIT, load_text_rendering_data, save_condition_image
...
class TextGenerator:
    def __init__(self, model_dir='/data/model_zoo/AnyText2', model_path='/data/model_zoo/AnyText2/anytext_v2.0.ckpt', 
        ...
        """初始化文字生成器"""
        # 构建字体文件路径
        font_path = os.path.join(ROOT_DIR, 'assets', 'fonts', 'Arial_Unicode.ttf')
        infer_params = {
            "use_fp16": use_fp16,
...
def process_dataset_data(dataset_name=DEFAULT_DATASET, split=TEXT_RENDERING_SPLIT, data_file=None,
                         base_mask_path=None, base_save_path=os.path.join(ROOT_DIR, "outputs", "text_rendering", "AnyText2"),
...
def main():
    ...
    parser.add_argument('--base_save_path', default=os.path.join(ROOT_DIR, "outputs", "text_rendering", "AnyText2"), help='Output image base path')
