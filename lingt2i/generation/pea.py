...
from lingt2i.data import CONTENT_GENERATION_SPLIT, DEFAULT_DATASET, load_content_generation_data
...
parser.add_argument('--flux_path', type=str, default="black-forest-labs/FLUX.1-schnell")
parser.add_argument('--t5_path', type=str, default='google/byt5-xxl')
parser.add_argument('--proj_path', type=str, default=os.path.join(ROOT_DIR, "models", "MultilingualFLUX.1-adapter", "diffusion_pytorch_model.bin"))
...
parser.add_argument('--output_dir', type=str, default=os.path.join(ROOT_DIR, "outputs", "content_generation", "PEA"))
